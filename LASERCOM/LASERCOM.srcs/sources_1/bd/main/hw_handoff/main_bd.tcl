...
proc create_root_design { parentCell } {
  ...
  # Create instance: TEST_IN, and set properties
  set TEST_IN [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 TEST_IN ]
  set_property -dict [ list \
   CONFIG.C_ALL_INPUTS {1} \
   CONFIG.C_GPIO_WIDTH {6} \
 ] $TEST_IN

  # Create instance: THRESHOLDS, and set properties
  set THRESHOLDS [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 THRESHOLDS ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
  ...
  # Create instance: TX_FULL_IO, and set properties
  set TX_FULL_IO [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 TX_FULL_IO ]
  set_property -dict [ list \
   CONFIG.C_ALL_INPUTS {1} \
  ...
  # Create instance: TX_SEND_IO, and set properties
  set TX_SEND_IO [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 TX_SEND_IO ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
   CONFIG.C_GPIO_WIDTH {1} \
 ] $TX_SEND_IO
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins TEST_IN/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M07_AXI [get_bd_intf_pins THRESHOLDS/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M07_AXI]
  ...
  connect_bd_net -net PUFART_0_buffer [get_bd_pins PUFART_0/buffer] [get_bd_pins PUFART_OUT/gpio_io_i]
  connect_bd_net -net PUFART_0_ready [get_bd_pins PUFART_0/ready] [get_bd_pins PUFART_READY/gpio_io_i]
  connect_bd_net -net PUFART_READ_gpio_io_o [get_bd_pins PUFART_0/read] [get_bd_pins PUFART_READ/gpio_io_o]
  connect_bd_net -net THRESHOLDS_gpio_io_o [get_bd_pins PUFART_0/thresholds] [get_bd_pins THRESHOLDS/gpio_io_o]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41270000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs THRESHOLDS/S_AXI/Reg] SEG_THRESHOLDS_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41260000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs TEST_IN/S_AXI/Reg] SEG_axi_gpio_0_Reg1
