...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PUFART is
  ...
  signal \datacount[31]_i_12_n_0\ : STD_LOGIC;
  signal \datacount[31]_i_13_n_0\ : STD_LOGIC;
  ...
  signal \datacount_reg[31]_i_8_n_1\ : STD_LOGIC;
  signal \datacount_reg[31]_i_8_n_2\ : STD_LOGIC;
  signal \datacount_reg[31]_i_8_n_3\ : STD_LOGIC;
  ...
  signal \NLW_datacount_reg[31]_i_8_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \buffer[13]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \buffer[14]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \buffer[15]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \buffer[16]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \buffer[17]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \buffer[18]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \buffer[19]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \buffer[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \buffer[20]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \buffer[21]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \buffer[22]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \buffer[23]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \buffer[24]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \buffer[25]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \buffer[26]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \buffer[27]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \buffer[28]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \buffer[29]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \buffer[2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \buffer[30]_i_1\ : label is "soft_lutpair25";
  ...
  attribute SOFT_HLUTNM of \clockcount[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \clockcount[10]_i_1\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \clockcount[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \clockcount[2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \clockcount[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \clockcount[4]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \clockcount[5]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \clockcount[6]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \clockcount[7]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \clockcount[8]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \clockcount[9]_i_1\ : label is "soft_lutpair8";
begin
  ready <= \^ready\;
...
\clockcount[19]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAAABF"
    )
        port map (
...
\datacount[31]_i_10\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
\datacount[31]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => datacount(6),
      I3 => datacount(5),
      O => \datacount[31]_i_12_n_0\
    );
\datacount[31]_i_13\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\datacount[31]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
        ...
        port map (
      I0 => \datacount[31]_i_12_n_0\,
      I1 => datacount(12),
      I2 => datacount(11),
      I3 => datacount(10),
      I4 => datacount(9),
      I5 => \datacount[31]_i_13_n_0\,
...
\datacount[31]_i_9\: unisim.vcomponents.LUT6
    generic map(
...
\datacount_reg[31]_i_8\: unisim.vcomponents.CARRY4
     port map (
      CI => \datacount_reg[27]_i_2_n_0\,
      CO(3) => \NLW_datacount_reg[31]_i_8_CO_UNCONNECTED\(3),
      CO(2) => \datacount_reg[31]_i_8_n_1\,
      CO(1) => \datacount_reg[31]_i_8_n_2\,
      CO(0) => \datacount_reg[31]_i_8_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
\interbuffer[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FDFFF8F0F0F0F0F0"
    )
        port map (
      I0 => \clockcount[19]_i_4_n_0\,
      I1 => \interbuffer_reg_n_0_[0]\,
      I2 => \datacount[31]_i_9_n_0\,
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PUFART
     port map (
      ...
      clk => clk,
      data(3 downto 0) => data(5 downto 2),
      read => read,
      ready => ready,
      rst => rst
    );
