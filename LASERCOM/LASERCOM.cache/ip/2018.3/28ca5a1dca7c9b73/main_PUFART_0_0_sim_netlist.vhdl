...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PUFART is
  ...
  signal \buffer[31]_i_23_n_0\ : STD_LOGIC;
  signal \buffer[31]_i_27_n_0\ : STD_LOGIC;
  signal \buffer[31]_i_28_n_0\ : STD_LOGIC;
  signal \buffer[31]_i_2_n_0\ : STD_LOGIC;
  signal \buffer[31]_i_32_n_0\ : STD_LOGIC;
  signal \buffer[31]_i_34_n_0\ : STD_LOGIC;
  ...
  signal \buffer_reg[31]_i_25_n_0\ : STD_LOGIC;
  signal \buffer_reg[31]_i_25_n_1\ : STD_LOGIC;
  signal \buffer_reg[31]_i_25_n_2\ : STD_LOGIC;
  signal \buffer_reg[31]_i_25_n_3\ : STD_LOGIC;
  ...
  signal \buffer_reg[31]_i_30_n_0\ : STD_LOGIC;
  signal \buffer_reg[31]_i_30_n_1\ : STD_LOGIC;
  signal \buffer_reg[31]_i_30_n_2\ : STD_LOGIC;
  signal \buffer_reg[31]_i_30_n_3\ : STD_LOGIC;
  ...
  signal \NLW_buffer_reg[31]_i_24_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_buffer_reg[31]_i_24_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \buffer[15]_i_4\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \buffer[23]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \buffer[23]_i_4\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \buffer[25]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \buffer[26]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \buffer[27]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \buffer[28]_i_2\ : label is "soft_lutpair21";
  ...
  attribute SOFT_HLUTNM of \buffer[31]_i_18\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \buffer[31]_i_3\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \buffer[31]_i_6\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \buffer[31]_i_7\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \buffer[7]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \buffer[7]_i_4\ : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of \datacount[17]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \datacount[18]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \datacount[19]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \datacount[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \datacount[20]_i_1\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of in_progress_i_2 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \inter[0]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \inter[0]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \inter[1]_i_1\ : label is "soft_lutpair3";
begin
  ready <= \^ready\;
...
\buffer[20]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFF0000F1E0F1E0"
        ...
        port map (
      I0 => \buffer[23]_i_2_n_0\,
      I1 => \buffer[28]_i_2_n_0\,
      I2 => \buffer[20]_i_2_n_0\,
      I3 => \inter_reg_n_0_[1]\,
      I4 => interbuffer(20),
      I5 => \buffer[31]_i_5_n_0\,
...
\buffer[21]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFF0000F1E0F1E0"
        ...
        port map (
      I0 => \buffer[23]_i_2_n_0\,
      I1 => \buffer[29]_i_2_n_0\,
      I2 => \buffer[21]_i_2_n_0\,
      I3 => \inter_reg_n_0_[1]\,
      I4 => interbuffer(21),
      I5 => \buffer[31]_i_5_n_0\,
...
\buffer[31]_i_13\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => clockcount_reg(18),
      I3 => \buffer[31]_i_22_n_0\,
      I4 => \buffer[31]_i_23_n_0\,
...
\buffer[31]_i_15\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => interbuffer1(7),
      I2 => interbuffer1(11),
      I3 => \buffer[31]_i_27_n_0\,
      I4 => \buffer[31]_i_28_n_0\,
...
\buffer[31]_i_17\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => interbuffer1(30),
      I3 => interbuffer1(26),
      I4 => \buffer[31]_i_34_n_0\,
      O => \buffer[31]_i_17_n_0\
    );
\buffer[31]_i_18\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
\buffer[31]_i_22\: unisim.vcomponents.LUT4
    generic map(
      ...
      I0 => clockcount_reg(8),
      I1 => clockcount_reg(7),
      I2 => clockcount_reg(12),
      I3 => clockcount_reg(9),
      O => \buffer[31]_i_22_n_0\
    );
\buffer[31]_i_23\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => clockcount_reg(14),
      O => \buffer[31]_i_23_n_0\
    );
\buffer[31]_i_27\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => interbuffer1(20),
      I3 => interbuffer1(23),
      O => \buffer[31]_i_27_n_0\
    );
\buffer[31]_i_28\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\buffer[31]_i_32\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => interbuffer1(12),
      I3 => interbuffer1(27),
      O => \buffer[31]_i_32_n_0\
    );
\buffer[31]_i_34\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\buffer[31]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFDFFFF"
    )
        port map (
...
\buffer[31]_i_7\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\buffer_reg[31]_i_24\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_buffer_reg[31]_i_24_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \buffer_reg[31]_i_24_n_2\,
      CO(0) => \buffer_reg[31]_i_24_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_buffer_reg[31]_i_24_O_UNCONNECTED\(3),
      O(2 downto 0) => interbuffer1(31 downto 29),
      S(3) => '0',
      S(2 downto 0) => datacount(31 downto 29)
    );
\buffer_reg[31]_i_25\: unisim.vcomponents.CARRY4
     port map (
      CI => \buffer_reg[31]_i_14_n_0\,
      CO(3) => \buffer_reg[31]_i_25_n_0\,
      CO(2) => \buffer_reg[31]_i_25_n_1\,
      CO(1) => \buffer_reg[31]_i_25_n_2\,
      CO(0) => \buffer_reg[31]_i_25_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
\buffer_reg[31]_i_30\: unisim.vcomponents.CARRY4
     port map (
      CI => \buffer_reg[31]_i_26_n_0\,
      CO(3) => \buffer_reg[31]_i_30_n_0\,
      CO(2) => \buffer_reg[31]_i_30_n_1\,
      CO(1) => \buffer_reg[31]_i_30_n_2\,
      CO(0) => \buffer_reg[31]_i_30_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
in_progress_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00FD"
        ...
        port map (
      I0 => in_progress_i_2_n_0,
      I1 => data(4),
      I2 => in_progress,
      I3 => \buffer[31]_i_1_n_0\,
      O => in_progress_i_1_n_0
    );
in_progress_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0007"
    )
        port map (
...
\inter[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"15"
    )
        port map (
...
\inter[0]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"88888880"
    )
        port map (
...
\inter[0]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
