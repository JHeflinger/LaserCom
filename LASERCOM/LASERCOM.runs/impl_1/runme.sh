...
HD_PWD='/home/jason/Dev/LaserCom/LASERCOM/LASERCOM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LASERCOM_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LASERCOM_wrapper.tcl -notrace
