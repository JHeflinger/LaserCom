...
HD_PWD='/home/jason/Dev/LaserCom/LASERCOM/LASERCOM.runs/main_axi_gpio_0_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_axi_gpio_0_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_axi_gpio_0_6.tcl
