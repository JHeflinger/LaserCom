...
HD_PWD='/home/jason/Dev/LaserCom/LASERCOM/LASERCOM.runs/main_PUFART_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_PUFART_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_PUFART_0_0.tcl
